...
Options::Options(const vector<char> &options) {
  ...
  // Reading options in order
  // option 'c' overwrites any previous 'm'
  // option 'm' overwrites any previous 'c'
...
bool Options::CountingLines() const { return counting_lines_; }

bool Options::CountingWords() const { return counting_words_; }

bool Options::CountingChars() const { return counting_chars_; }
